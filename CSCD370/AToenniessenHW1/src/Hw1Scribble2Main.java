...
public class Hw1Scribble2Main extends Application
{
    ...
    public void start(Stage primaryStage) {
        ...
        mCanvas.setOnMouseReleased(mouseEvent -> refreshUndoRedo());
        ...
        primaryStage.setTitle("Homework_1");
    ...
    private void onAbout() {
        ...
        alert.setTitle("Homework_1");
        alert.setHeaderText("Alexander Toennissen, Fall 2017");
    ...
    private void initCanvas(boolean canUndo) {
        if(canUndo) {
