...
public class SevenSegment extends View {
    ...
    private final boolean[][] mSegmentState = {{true, true, false, true, true, true, true}, {false, true, false, true, false, false, false},
    ...
    protected void onDraw(Canvas canvas){
        ...
        //segment five
        drawSegment(canvas, 90, 0, 0, mSegmentState[mCurrentDisplay][4]);

        //segment six
        drawSegment(canvas, 90, 0, 15, mSegmentState[mCurrentDisplay][5]);
