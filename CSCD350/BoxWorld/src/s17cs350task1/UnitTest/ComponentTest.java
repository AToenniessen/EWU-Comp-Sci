...
public class ComponentTest {
    private static A_Component b1, b2, b3, b4, b5, b6, b7, b8;

    private static void connectBoxes(A_Component b1, A_Component b2) {
    ...
    public void setUp() {
        ...
        b1 = new A_Component("Box1", true);
        b2 = new A_Component("Box2");
        b3 = new A_Component("Box3");
        b4 = new A_Component("Box4");
        b5 = new A_Component("box1");
        b6 = new A_Component("Box1");
        b7 = new A_Component("Box7", true);
        b8 = new A_Component("Box8");
        connectBoxes(b1, b2);
        connectBoxes(b2, b3);
        connectBoxes(b2, b4);
    }
    ...
    void test_clone() throws CloneNotSupportedException {
        A_Component c1 = b1.clone();
        assertEquals(b1, c1);
        assertFalse(b1 == c1);
        A_Component c2 = b2.clone();
        assertEquals(b2, c2);
        assertFalse(b2 == c2);
    }
...
//        String expected = "A_Component[id='Box1', isRoot=true, size=Dimension3D [w = 1.0, h = 1.0, d = 1.0]]" +
//                "\n\tConnector[GoodParent=true, offset=Point3D [x = 5.0, y = 5.0, z = 5.0]] -> A_Component[id='Box2', isRoot=false, size=Dimension3D [w = 2.0, h = 2.0, d = 2.0]]" +
//                "\n\t\tConnector[GoodParent=true, offset=Point3D [x = 5.0, y = 5.0, z = 5.0]] -> A_Component[id='Box3', isRoot=false, size=Dimension3D [w = 3.0, h = 3.0, d = 3.0]]" +
//                "\n\t\tConnector[GoodParent=true, offset=Point3D [x = 5.0, y = 5.0, z = 5.0]] -> A_Component[id='Box4', isRoot=false, size=Dimension3D [w = 4.0, h = 4.0, d = 4.0]]" +
//                "\n\tConnector[GoodParent=true, offset=Point3D [x = 5.0, y = 5.0, z = 5.0]] -> A_Component[id='Box8', isRoot=false, size=Dimension3D [w = 2.0, h = 3.0, d = 4.0]]";
...
//        expected = "A_Component[id='Box2', isRoot=false, size=Dimension3D [w = 2.0, h = 2.0, d = 2.0]]" +
//                "\n\tConnector[GoodParent=true, offset=Point3D [x = 5.0, y = 5.0, z = 5.0]] -> A_Component[id='Box3', isRoot=false, size=Dimension3D [w = 3.0, h = 3.0, d = 3.0]]" +
//                "\n\tConnector[GoodParent=true, offset=Point3D [x = 5.0, y = 5.0, z = 5.0]] -> A_Component[id='Box4', isRoot=false, size=Dimension3D [w = 4.0, h = 4.0, d = 4.0]]";
...
//    }
    ...
    @Test
    void test_equals() {
        A_Component b72 = new A_Component("Box7", true);
        assertEquals(b72, b7);
        assertEquals(b1, b1);
    }
